...
const QUESTIONS: GenericQuizQuestion[] = [
  {
    id: 0,
    question: "Primeiro, me diga: qual destas situações mais te frustra ",
    questionHighlight: "HOJE?",
    subtext: "Saber a sua maior frustração nos ajuda a personalizar sua jornada.",
    type: 'card',
    options: [
  ...
  {
    id: 12,
    question: "Estamos finalizando seu protocolo. O que seria a maior vitória para você?",
    subtext: "Visualize seu sucesso. O que mais te motiva a mudar?",
    type: 'multi',
    columns: 2,
    options: [
  ...
  {
    id: 20,
    question: "Seu sono é a chave. Como você descreveria suas noites?",
    subtext: "O ritual noturno age enquanto você dorme. Precisamos entender seu padrão de sono.",
    type: 'card',
    options: [
            ...
            {currentQuestion.type === 'info' && (
              <div className="w-full flex flex-col items-center animate-fadeIn">
                <div className="relative mb-8 w-full">
                  <div className="bg-white rounded-3xl overflow-hidden shadow-2xl flex items-center justify-center border border-gray-100 p-1">
                    <img 
                      src="https://ik.imagekit.io/ekdmcxqtr/Gemini_Generated_Image_c8uuvbc8uuvbc8uu%20(1).png?updatedAt=1770745556349" 
                      alt="Ritual da Gelatina" 
                      className="w-full h-auto rounded-2xl"
                    />
                  </div>
                </div>
                <button onClick={(e) => handleContinue(e)} className="w-full py-5 btn-gradient rounded-2xl font-extrabold text-white text-lg shadow-xl hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-2 uppercase">Entendido! Continuar 🚀</button>
              </div>
            )}
